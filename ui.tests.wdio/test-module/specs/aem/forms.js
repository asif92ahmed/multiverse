...
describe('AEM Forms OOTB Content Tests', () => {
    ...
    describe.skip('DataSource Tests', () => {
        let dataSources = [
            ...
            confPath = '/conf/multiverse/settings/cloudconfigs/fdm',
    ...
    describe('Form Data Model Tests', () => {
        ...
        let formDataModels = [
            ...
            basePath = 'aem/fdm/editor.html/content/dam/formsanddocuments-fdm/multiverse',
    ...
    describe('AEM Forms Templates E2E Testing', () => {
        let templates = [
                {path : '/conf/multiverse/settings/wcm/templates/basic-af', isBlankForm : false, verificationRuleFilePath : '../../rules/template-rules.json'},
                {path : '/conf/multiverse/settings/wcm/templates/blank-af', isBlankForm : true}
            ],
            tabbedLayoutCount = 0,
    ...
    describe('Theme testing', () => {
        const getThemePath = (theme) => '/content/dam/formsanddocuments-themes/multiverse/' + theme + '/jcr:content?wcmmode=disabled';
    ...
    describe('DataLayer testing', () => {
        ...
        const templatePath = '/conf/multiverse/settings/wcm/templates/blank-af-v2';
